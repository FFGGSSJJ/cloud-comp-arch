...
# Schedule jobs
location = "../config/parsec-benchmarks/part3/v2/" # Change this variable to proper location if necessary.
 
vm4jobs = ["parsec-dedup.yaml", "parsec-vips.yaml", "parsec-radix.yaml", "parsec-canneal.yaml", "parsec-blackscholes.yaml"]
vm8jobs = ["parsec-freqmine.yaml", "parsec-ferret.yaml"]
