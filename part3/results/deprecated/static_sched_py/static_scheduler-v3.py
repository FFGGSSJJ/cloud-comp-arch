...
# Schedule jobs
location = "../config/parsec-benchmarks/part3/v3/" # Change this variable to proper location if necessary.
 
# vm4jobs = ["parsec-dedup.yaml", "parsec-vips.yaml", "parsec-freqmine.yaml"]
# vm8jobs = ["parsec-radix.yaml", "parsec-canneal.yaml", "parsec-blackscholes.yaml", "parsec-ferret.yaml"]
vm4jobs = ["parsec-dedup.yaml", "parsec-vips.yaml", "parsec-radix.yaml", "parsec-freqmine.yaml"]
vm8jobs = ["parsec-canneal.yaml", "parsec-blackscholes.yaml", "parsec-ferret.yaml"]
